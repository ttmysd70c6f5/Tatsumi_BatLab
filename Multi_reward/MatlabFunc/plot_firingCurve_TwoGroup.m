function plot_firingCurve_TwoGroup(sptimes_sec_1,sptimes_sec_2,sp_edges,sp_bin,gname)
% Parameters
...
[fr_2,sem_2] = compute_psth_v2(sptimes_sec_2,sp_edges,sp_bin,filt_smp);
...
% line at t = 0
p3 = line([0 0], [0 y_max],'Color',[150 150 150 255]/255,'LineWidth',2);
hold off
