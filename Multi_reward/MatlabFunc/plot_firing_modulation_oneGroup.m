function plot_firing_modulation_oneGroup(t_onset_sec_1,t_end_sec_1,t_margin,sptimes_unit_sec)
...
hold on
plot_RasterPlot_oneGroup(sptimes_sec_1)
...
xlim([t_margin(1), max(t_diff_1)+t_margin(2)])
...
% end
plot_firingCurve_oneGroup(sptimes_sec_1,sp_edges,sp_bin)
