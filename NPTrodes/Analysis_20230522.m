...
prb_angle = 46; % angle of probe
gain = 50; % LFP gain

% depth = depth*cosd(prb_angle); %correct for manipulator angle (degree from vertical)
...
% lfp(1:192,:) = lfp(1:192,:) - median(lfp(1:192,:),1);
% lfp(193:384,:) = lfp(193:384,:) - median(lfp(193:384,:),1);
% for i = 1:12
%     lfp(i:12:384,:) = lfp(i:12:384,:) - median(lfp(i:12:384,:),1);
% end
...
% % Randomly sample 60*Fs points
% lfp = lfp(:,randsample(size(lfp,2),fs*60));
