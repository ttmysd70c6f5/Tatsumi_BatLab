function [data] = readTrodesNoHeader(fname, varargin)  
...
%%
ops.fbinary = 'C:\Users\Tatsumi\Documents\Data\KQTY_NP\32623\20230907_161730.rec\20230907_161730_merged.kilosort\20230907_161730_merged.probe1.dat';
ops.fproc   = 'C:\Users\Tatsumi\Documents\Data\KQTY_NP\32623\20230907_161730.rec\20230907_161730_merged.kilosort\temp_wh.dat';
o = dir(ops.fbinary);
bytes = o.bytes; % data size in bytes
ops.ntbuff              = 64;    % samples of symmetrical buffer for whitening and spike detection
ops.NT                  = 64*1024+ ops.ntbuff; % must be multiple of 32 + ntbuff. This is the batch size (try decreasing if out of memory). 
NT = ops.NT;
NchanTOT = 384; % total number of channels

nTimepoints = floor(bytes/NchanTOT/2); % number of total timepoints
ops.fs = 30000; % sampling rate (Hz)
ops.trange = [0 Inf]; % range of timepoint
...
% 
% 
% headerText = fread(fid,10000,'int16');
