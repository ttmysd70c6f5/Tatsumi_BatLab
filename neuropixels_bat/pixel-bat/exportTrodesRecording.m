function [] = exportTrodesRecording(path_to_rec_dir, path_to_trodes, varargin)
...
parse(p,path_to_rec_dir,path_to_trodes,varargin{:});
...
spikeband_options = sprintf("-spikehighpass %d -spikelowpass %d -usespikefilters 0", spikesFreqBand(1), spikesFreqBand(2)); % spikes export parameters
