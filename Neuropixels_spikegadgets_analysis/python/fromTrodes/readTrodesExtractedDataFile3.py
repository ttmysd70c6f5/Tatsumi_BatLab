...
# Testing function was commented out by Tatsumi Yoshida because it can cause an error.
# The cause of error is that np.nan is not supported with the current version of NumPy.
# If you want to run this testing function, you should replace the 2nd lines with this:
# np.set_printoption(threshold=np.inf)
