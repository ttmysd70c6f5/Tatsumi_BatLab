...
def read_header(spikegadgets_path):
    header_size = None
    with open(spikegadgets_path, mode='rb') as f:
        while True:
            line = f.readline()
...
def read_header(self):
    ...
    packet_size = 1
    stream_bytes = {}
    devices = hconf.findall("Device") # Modified by TY on 230920 to load SpikeGadgets NP data
    # for device in hconf: # Modified by TY on 230920 to load SpikeGadgets NP data
    for device in devices: # Modified by TY on 230920 to load SpikeGadgets NP data
